...
SECRET_KEY = 'django-insecure-v5yc=%#0rf1x1(ld+if9)$jrpb&c=19hxefw%y5r3!zr1+yeqn'
...
ADMIN_SITE_HEADER = 'TrackerJet Administration'
ADMIN_SITE_INDEX_TITLE ='Lead Management System'
